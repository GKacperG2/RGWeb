          ...
          <div className="max-w-7xl mx-auto px-5 md:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-white/80 font-body">
                Zadzwoń lub napisz – realizujemy niestandardowe projekty szklane.
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              <a
                href={PHONE_HREF}
                className="shrink-0 inline-flex items-center gap-2.5 bg-white text-[var(--color-primary)] font-heading font-bold rounded-full px-7 py-3.5 hover:bg-white/90 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg text-sm"
              >
              ...
              <Link
                href="/kontakt/"
                className="shrink-0 inline-flex items-center gap-2.5 bg-white/20 hover:bg-white/30 text-white font-heading font-bold rounded-full px-7 py-3.5 transition-all duration-200 hover:-translate-y-0.5 text-sm border border-white/30"
              >
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
